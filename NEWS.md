...
- Vignette describing the use of the `return_interim` parameter in `find_clusters()` and the intermediate objects returned (#32)
...
- Adds basic mapping functionality using new function `map_clusters()` (#17)
