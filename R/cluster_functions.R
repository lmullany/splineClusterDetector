...
#'
#' Function takes a spline lookup table, and an object of class
#' ObservedExpectedGrid and identfies which rows in each potential centroid have
#' observed over expected values that exceed a threshold for that observed value
#' TODO: add a default system data object that contains a default spline lookup?
#' @param oe_grid An object of class `ObservedExpectedGrid` generated by
#'   `generate_observed_expected()`
#' @param spline_lookup a spline lookup table; a data frame that has at least
#'   two columns: including "observed" and "spl_thresh"
#' @export
#' @returns a frame containing rows of oe_grid that are candidate alert clusters
add_spline_threshold <- function(oe_grid, spline_lookup) {
...
#' @param spline_lookup a two-column frame with observed values and spline
#'   detection threshold
